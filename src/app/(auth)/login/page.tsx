...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen relative flex flex-col items-center justify-center p-4 overflow-hidden">
            ...
            <div className="fixed bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-600/20 rounded-full blur-[120px] -z-10" />
            ...
            <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-700">
                ...
                <Card className="glass-card border-border/40 shadow-2xl relative overflow-hidden backdrop-blur-xl">
                    <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-primary/50 via-blue-500/50 to-primary/50" />
                    ...
                    <CardHeader className="space-y-1 pb-6 relative z-10 pt-8">
                        ...
                        <CardDescription className="text-center">
                            Access your secure developer vault
                        </CardDescription>
                    </CardHeader>
